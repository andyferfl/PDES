...
export SCHEDULE_DISTANCE_SST_DIR=$SCHEDULE_DISTANCE_DIR/nullmessages/phold
export SCHEDULE_DISTANCE_SST_SRC_DIR=$SCHEDULE_DISTANCE_SST_DIR/src
export SCHEDULE_DISTANCE_SST_LIB_DIR=$SCHEDULE_DISTANCE_SST_SRC_DIR/lib

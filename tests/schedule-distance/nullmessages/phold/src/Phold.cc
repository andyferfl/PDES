 ...
 */
 ...
 Phold::ShowConfiguration(double thread_latency) const
 {
   ...
   std::string runMode;
   switch (SST::Simulation_impl::getSimulation()->getSimulationMode())
     {
     case SST::SimulationRunMode::INIT:     runMode = "INIT";        break;
     case SST::SimulationRunMode::RUN:      runMode = "RUN";         break;
     case SST::SimulationRunMode::BOTH:     runMode = "BOTH";        break;
     case SST::SimulationRunMode::UNKNOWN:  runMode = "UNKNOWN";     break;
